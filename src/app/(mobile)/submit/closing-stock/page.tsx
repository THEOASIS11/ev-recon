      ...
      <>
        ...
        >
          ...
          <p className="s-sub" style={{ color: '#71717a', fontSize: '14px', margin: 0 }}>
            Closing stock recorded and locked.
          </p>
        </div>
      </>
    );
    ...
    <>
                    ...
                    {isReadOnly ? (
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        <div>
                          ...
                          <div className="cs-display">{parseNum(e.sellable)}</div>
                        </div>
                        <div>
                          <label className="field-label">Unassembled</label>
                          <div className="cs-display">{parseNum(e.unassembled)}</div>
                        </div>
                        <div>
                          <label className="field-label">Defective</label>
                          <div className="cs-display">{parseNum(e.defective)}</div>
                        </div>
                      </div>
                    ) : (
                      // Editable inputs
      ...
      {!isReadOnly && (
        ...
        >
          ...
          >
            {loading ? 'Submitting...' : 'Submit Closing Stock'}
          </button>
        </div>
      )}
    </>
